...
public class GiftInventoryBarActor extends Actor {
    ...
    public GiftInventoryBarActor(FriendshipStageHandler friendshipStageHandler, OrthographicCamera camera, Inventory inventory, BitmapFont font) {
