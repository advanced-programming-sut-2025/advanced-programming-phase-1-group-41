...
public class CraftingController {
    ...
    private Result FishSmoker(Matcher matcher){}
    ...
    private Result furnace(Matcher matcher){}

    private Result jarPreserver(Matcher matcher){}

    private Result oilMaker(Matcher matcher){}

    private Result MayonnaiseMachine(Matcher matcher){}

    private Result loom(Matcher matcher){}
