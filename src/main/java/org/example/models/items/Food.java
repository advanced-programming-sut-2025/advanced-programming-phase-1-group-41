...
public enum Food implements Item {
    ...
    HashBrowns(90, 120, null, "HashBrowns"),
    Pancakes(90, 80, null, "Pancakes"),
    FruitSalad(263, 450, null, "FruitSalad"),
    RedPlate(240, 400, null, "RedPlate"),
    Bread(50, 60, CookingRecipe.Bread, "Bread"),
    SalmonDinner(125, 300, null, "SalmonDinner"),
    VegetableMedley(165, 120, null, "VegetableMedley"),
    FarmerLunch(200, 150, null, "FarmerLunch"),
    SurvivalBurger(125, 180, null, "SurvivalBurger"),
    DishOTheSea(150, 220, null, "DishOTheSea"),
    SeaFormPudding(175, 300, null, "SeaFormPudding"),
    MinerTreat(125, 200, null, "MinerTreat"),
